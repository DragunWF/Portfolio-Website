      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {blogs.map((blog, index) => (
          ...
          >
            ...
            <div className={`h-48 w-full relative flex items-center justify-center border-b border-slate-800 ${index === 0 ? 'bg-gradient-to-br from-slate-800 to-slate-900' : 'bg-gradient-to-bl from-slate-800 to-slate-900'}`}>
