  ...
  return (
    <SectionContainer id="contact" className="py-16 mb-12 scroll-mt-20">
      <div className="p-8 md:p-12 bg-slate-900/80 border border-slate-800 rounded-3xl backdrop-blur-md relative overflow-hidden">
        ...
        {isSuccess ? (
          <div className="max-w-2xl mx-auto text-center py-10 flex flex-col items-center">
            ...
            <p className="text-slate-400 text-lg mb-8">
              Thanks for reaching out, {name.split(" ")[0]}. I&apos;ve received
          ...
          <>
            <div className="max-w-2xl mx-auto text-center mb-10">
              ...
              <p className="text-slate-400 text-lg">
                Whether it's an enterprise backend or an indie game, I'm always
