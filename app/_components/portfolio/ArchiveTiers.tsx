    ...
    <section className="mb-16">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {achievements.map((ach) => (
          <div
            key={ach.id}
            className="flex flex-col p-5 bg-slate-900/80 border border-slate-800/80 rounded-2xl transition-colors hover:border-emerald-500/30"
          >
            ...
            <div className="flex flex-col flex-1">
              <h4 className="text-lg font-bold text-slate-200">{ach.title}</h4>
    ...
    <section className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {achievements.map((ach) => (
          <div
            key={ach.id}
            className="flex flex-col sm:flex-row bg-slate-900/50 border border-slate-800 rounded-xl overflow-hidden transition-all hover:border-emerald-500/20 p-4 gap-4"
          >
