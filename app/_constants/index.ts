      ...
      roles: [
        {
          ...
          description: [
            "Engineer custom applications through full-stack Salesforce Development, leveraging Apex, SOQL, SOSL, Git, GitHub, and Lightning Web Components (LWC) integrated with JavaScript, HTML, and CSS.",
  ...
  volunteering: [
    {
      ...
      description: [
        "Served as a full-stack web and cross-platform mobile developer, building organizational digital platforms and managing technical operations for seminars and competitions using React, Next.js, Django, MongoDB, React Native, TypeScript, Python, Firebase, Cloudinary, Git, and GitHub.",
        "Led a development team to build and deploy the official General Assembly web platform using React, Git, and Django, streamlining the digital registration process for over 200+ onsite attendees.",
        "Programmed a custom Python Discord bot to automate community operations, implementing a secure member verification process for 60+ members alongside utility commands and interactive mini-games.",
        "Co-developed an organizational Content Management System (CMS) and administrative dashboard using Next.js and MongoDB to support internal data management and event logistics.",
        "Developed a modern, cross-platform mobile messaging application leveraging React Native, TypeScript, Firebase, Git, and Cloudinary.",
        "Provided onsite IT support and managed technical operations to ensure the seamless execution of major campus events, technical seminars, and programming competitions.",
      ],
      skills: [
        "React",
        "Next.js",
    ...
    {
      id: "vol-csg",
      role: "ICT Councilor & Web Developer",
      startDate: "Apr 2024",
      endDate: "Jun 2025",
